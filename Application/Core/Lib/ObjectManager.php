...
abstract class ObjectManager extends Hooks implements ObjectManagerInterface{
    ...
    public function GetComponent($component) {
        ...
        {
            Debugger::debugMessage("Attempting to fetch Component: $component");
    ...
    public function GetCoreObject($object, $args = null){
        ...
        if (! isset(self::$objects[$object])) {
            $fullClassPath = $this->DirectoryToNamespace(\Get::Config('APPDIRS.CORE.LIB_FOLDER')).$object;
    ...
    {
        self::ThrowStaticError("Class '<b>$class</b>' was not found</b>, called from ".  get_called_class());
    }
